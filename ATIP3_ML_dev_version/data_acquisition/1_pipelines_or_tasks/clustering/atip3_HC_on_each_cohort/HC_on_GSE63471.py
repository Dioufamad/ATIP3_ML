...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE63471_ATIP3probesetsonly_probesnames_3x142_GEX.csv"
sep_in_file = ","
...
clusters_placement_dictionary ={3 : "low", 1 : "low_med", 0 : "med_high", 2 : "high"} # use this for 4 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki'}
...
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE63471_ATIP3probesetsonly_probesnames_142x5_ph.csv"
sep_in_file = ","
...
old_cols_list = ["ER_status","PR_status","TNBC","pCR_status"]
new_cols_list = ["RO_status","PR_status","TN_status","RCH"]
...
list_of_cols_to_drop_from_joined_table = ['cluster',"ATIP3_class_hm","RO_status","PR_status","TN_status","RCH"]
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE63471_ATIP3probesetsonly_InfoTreatmentCluster.csv"
