...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE26639_ATIP3probesetsonly_probesnames_4x226_GEX.csv"
sep_in_file = ","
...
print("The attributed colors to clusters were : ",my_palette_for_row_colors)
# clusters_placement_dictionary ={0 : "med", 1 : "low", 2 : "high"} # use this for 3 clusters
clusters_placement_dictionary ={1 : "low", 0 : "low_med", 3 : "med_high", 2 : "high"} # use this for 4 clusters
df_X_scaled['ATIP3_class_hm'] = df_X_scaled['cluster'].map(clusters_placement_dictionary)
# add the columns of the hormonal profiles
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE26639_ATIP3probesetsonly_probesnames_226x5_ph.csv"
sep_in_file = ","
...
old_cols_list = ["her2 status:ch1","oestrogen receptor:ch1","progesterone receptor:ch1","TNBC"]
new_cols_list = ["HER2_status","RO_status","PR_status","TN_status"]
...
supporting_file_path = "/data_warehouse/inputs/atip3_material/Sample_Names_correspondance/R02 pour Amad.xlsx"
sheet_id = 1
...
list_of_cols_to_drop_from_joined_table = ['cluster',"ATIP3_class_hm","HER2_status","RO_status","PR_status","TN_status","RCH"]
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE26639_ATIP3probesetsonly_InfoTreatmentCluster.csv"
...
list_of_cols_for_boxplots_of_expressions = ["212093_s_at","212095_s_at","212096_s_at","239576_at","ATIP3_class_hm" ]
...
chosen_x = "Probesets"
chosen_x_order = ["212093_s_at","212095_s_at","212096_s_at_(best_probeset)","239576_at"]
chosen_y = "value"
...
chosen_box_pairs=[
    ...
    (("239576_at", "low"), ("239576_at", "low_med")),
    (("239576_at", "low"), ("239576_at", "med_high")),
    (("239576_at", "med_high"), ("239576_at", "high")),
    ]
