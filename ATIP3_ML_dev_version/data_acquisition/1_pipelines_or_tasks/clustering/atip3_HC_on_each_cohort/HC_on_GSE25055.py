...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_ATIP3probesetsonly_probesnames_3x310_GEX.csv"
sep_in_file = ","
...
# clusters_placement_dictionary ={0 : "low", 1 : "med", 2 : "high"} # use this for 3 clusters {0: 'green', 1: 'blue', 2: 'red'}
clusters_placement_dictionary ={3 : "low", 2 : "low_med", 0 : "med_high", 1 : "high"} # use this for 4 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki'}
...
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_ATIP3probesetsonly_probesnames_310x6_ph.csv"
sep_in_file = ","
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE25055_ATIP3probesetsonly_InfoTreatmentCluster.csv"
