...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_ATIP3probesetsonly_probesnames_3x278_GEX.csv"
sep_in_file = ","
...
# clusters_placement_dictionary ={2 : "low", 1 : "low_med", 0 : "med_high", 3 : "high"} # use this for 4 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki'}
clusters_placement_dictionary ={4 : "low", 3 : "low", 1 : "low_med", 0 : "med_high", 2 : "high"} # use this for 5 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki', 4: 'orange'}
df_X_scaled['ATIP3_class_hm'] = df_X_scaled['cluster'].map(clusters_placement_dictionary)
# add the columns of the hormonal profiles
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_ATIP3probesetsonly_probesnames_278x7_ph.csv"
sep_in_file = ","
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE20194_ATIP3probesetsonly_InfoTreatmentCluster.csv"
