...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE32646_ATIP3probesetsonly_probesnames_4x115_GEX.csv"
sep_in_file = ","
...
# clusters_placement_dictionary ={3 : "low", 0 : "low_med", 2 : "med_high", 1 : "high"} # use this for 4 clusters
# NB : at 1st look, we see 4 clusters but when we divide by 4, the low cluster is very small and the low_med is eating the rest of (low+low_med). if we did 5, low_med can be divided in 2
clusters_placement_dictionary ={4 : "low", 1 : "low", 0 : "low_med", 3 : "med_high", 2 : "high"} # use this for 5 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki', 4: 'orange'} (the first lowest clusters are used as ATIP3 low )
df_X_scaled['ATIP3_class_hm'] = df_X_scaled['cluster'].map(clusters_placement_dictionary)
# add the columns of the hormonal profiles
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE32646_ATIP3probesetsonly_probesnames_115x6_ph.csv"
sep_in_file = ","
...
old_cols_list = ["HER2_status","ER_status","PR_status","TNBC","pCR_status"]
new_cols_list = ["HER2_status","RO_status","PR_status","TN_status","RCH"]
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE32646_ATIP3probesetsonly_InfoTreatmentCluster.csv"
