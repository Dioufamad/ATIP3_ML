...
filepath_1cohort_gex_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE41998_ATIP3probesetsonly_probesnames_3x279_GEX.csv"
sep_in_file = ","
...
# clusters_placement_dictionary ={1 : "low", 3 : "low_med", 0 : "med_high", 2 : "high"} # use this for 4 clusters
clusters_placement_dictionary ={2 : "low", 0 : "low", 1 : "low_med", 4 : "med_high", 3 : "high"} # use this for 5 clusters {0: 'green', 1: 'blue', 2: 'red', 3: 'khaki', 4: 'orange'}
df_X_scaled['ATIP3_class_hm'] = df_X_scaled['cluster'].map(clusters_placement_dictionary)
# add the columns of the hormonal profiles
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE41998_ATIP3probesetsonly_probesnames_279x7_ph.csv"
sep_in_file = ","
...
# fullname_file_w_treatment_and_clusters = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE41998_ATIP3probesetsonly_InfoTreatmentCluster.csv"
...
# tab_pCR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==1)] # the pCR status in the TP (2 groups)
# tab_NpR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==0)]
...
# tab_TN_low = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low")] # the TNBC & low
# tab_TN_low_med = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low_med")] # the TNBC & low_med
# tab_TN_med_high = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="med_high")] # the TNBC & med_high
# tab_TN_high = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="high")] # the TNBC & high
# tab_TN_low_pCR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==1) &(df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low")] # the TNBC & low with pCR
# tab_TN_low_med_pCR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==1) &(df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low_med")] # the TNBC & low_med with pCR
# tab_TN_low_NpR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==0) &(df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low")] # the TNBC & low with NpR
# tab_TN_low_med_NpR = df_X_scaled_joined[(df_X_scaled_joined.treatment=="treatment arm: Paclitaxel") & (df_X_scaled_joined.RCH==0) &(df_X_scaled_joined.TN_status=="yes") &(df_X_scaled_joined.ATIP3_class_hm=="low_med")] # the TNBC & low_med with NpR
# #>>>>>>>>>>>>>>>>>>>>>>>>>>
print("For the cohort analysed, the population stratification is :")
...
print("- Number of TN & low_med & pCR :",len(tab_TN_low_med_pCR)) # the TNBC & low_med with pCRATIP3_class_hm
