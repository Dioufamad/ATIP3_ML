...
# if (cohort=="Remagus02") {
#   textfile <- read.csv(file = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/R02_clusters.txt", header = TRUE) # for R02
# } else if (cohort=="Remagus04") {
#   textfile <- read.csv(file = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/R04_clusters.txt", header = TRUE) # for R04
# } else if (cohort=="MDAnderson") {
#   textfile <- read.csv(file = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/MDA_clusters.txt", header = TRUE) # for MDA
# } else
