...
cohort_name = "GSE20194"

#>>>>>>>>>>>>>> Loading fts data
#---set the name of the sheet where the data of the cohort is
filepath_1cohort_gex_data_bestprobesets_genesnames= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_bestprobesetsonly_genesnames_12151x278_GEX.csv"
sep_in_file = ","
...
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_ATIP3probesetsonly_InfoTreatmentCluster.csv"
sep_in_file = ","
...
#>>>> saving the df
fullname_file_of_ml_dataset = "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
