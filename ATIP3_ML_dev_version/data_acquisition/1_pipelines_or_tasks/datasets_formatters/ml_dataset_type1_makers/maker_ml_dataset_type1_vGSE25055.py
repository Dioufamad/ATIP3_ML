...
cohort_name = "GSE25055"

#>>>>>>>>>>>>>> Loading fts data
#---set the name of the sheet where the data of the cohort is
filepath_1cohort_gex_data_bestprobesets_genesnames= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_bestprobesetsonly_genesnames_12151x310_GEX.csv"
sep_in_file = ","
...
filepath_1cohort_ph_data_ATIP3probesonly= "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_ATIP3probesetsonly_InfoTreatmentCluster.csv"
sep_in_file = ","
...
df_sup_file_restricted1 = df_sup_file_restricted.loc[df_sup_file_restricted['Y_pCR'].isin([0, 1])] # 4 samples have nan in RCH
...
#>>>> saving the df
fullname_file_of_ml_dataset = "/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
