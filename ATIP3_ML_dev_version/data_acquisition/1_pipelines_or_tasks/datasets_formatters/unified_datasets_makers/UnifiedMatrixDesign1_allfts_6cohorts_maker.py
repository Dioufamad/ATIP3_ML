...
p_platform1 = [list_all_cols_df_file1,list_all_cols_df_file4,list_all_cols_df_file5,list_all_cols_df_file7]
...
list_of_dfs_Vpart1_b4_std = [df_file1_Vpart1.copy(),df_file2_Vpart1.copy(),df_file3_Vpart1.copy(),df_file4_Vpart1.copy(),df_file5_Vpart1.copy(),df_file7_Vpart1.copy()]
...
list_of_dfs_2_transform_Vpart1 = [df_file1_Vpart1,df_file2_Vpart1,df_file3_Vpart1,df_file4_Vpart1,df_file5_Vpart1,df_file7_Vpart1]
...
# - keep a copy of each single dataset for after operations comparisons
list_of_dfs_Vpart2_b4_std = [df_file1_Vpart2.copy(),df_file2_Vpart2.copy(),df_file4_Vpart2.copy(),df_file5_Vpart2.copy(),df_file7_Vpart2.copy()]
# introduce the naive scaler
...
# transform for each others dataset its fts frame
list_of_dfs_2_transform_Vpart2 = [df_file1_Vpart2,df_file2_Vpart2,df_file4_Vpart2,df_file5_Vpart2,df_file7_Vpart2]
num_fts_frame_changed = 0
# replacing all fts cols at once
...
# - keep a copy of each single dataset for after operations comparisons
list_of_dfs_Vpart3_b4_std = [df_file1_Vpart3.copy(),df_file4_Vpart3.copy(),df_file5_Vpart3.copy(),df_file7_Vpart3.copy()]
# introduce the naive scaler
...
# transform for each others dataset its fts frame
list_of_dfs_2_transform_Vpart3 = [df_file1_Vpart3,df_file4_Vpart3,df_file5_Vpart3,df_file7_Vpart3]
num_fts_frame_changed = 0
# replacing all fts cols at once
...
# df7
df_file7_stitched = pd.concat([list_of_dfs_2_transform_Vpart1[5],list_of_dfs_2_transform_Vpart2[4],list_of_dfs_2_transform_Vpart3[3],df_file7[list_of_non_fts_cols].copy()], axis=1, sort=False)
...
# Columns: 87442 entries, A1BG-AS1_in_GSE26639 to cohort
# dtypes: float64(87440), int64(1), object(1)
# memory usage: 152.8+ MB
#>>>> saving the df
fullname_file_of_df_joined_new_design1 = "/data_acquisition/1_pipelines_or_tasks/JoinNewDesign1AllFtsof6_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
