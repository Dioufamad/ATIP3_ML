...
# version for unifying 3 cohorts (ie the 3 datasets used for 3 single task Lasso FSs)
...
source_base_folder = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/"
#---set the name of the sheet where the data of the cohort is
filepath_of_ml_dataset1= source_base_folder + "GSE63471_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
filepath_of_ml_dataset2= source_base_folder + "GSE25055_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
filepath_of_ml_dataset3= source_base_folder + "GSE41998_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
sep_in_file = ","
...
p = [list_all_cols_df_file1,list_all_cols_df_file2,list_all_cols_df_file3]
result = set(p[0])
for s in p[1:]:
    result.intersection_update(s)
print("Number of columns retained as common : ",len(result)) # 12153 fts including 12151 genes
...
list_of_common_of_dfs_b4_std = [common_of_df_file1_b4_std,common_of_df_file2_b4_std,common_of_df_file3_b4_std]
# >>>> standardize the values across samples for each feature

# transform for each of the dataset its fts frame
list_of_dfs_2_transform = [common_of_df_file1,common_of_df_file2,common_of_df_file3]
...
# Index: 117 entries, GSM1550393 to GSM1030355
# Columns: 36455 entries, A1CF_in_GSE63471 to cohort
# dtypes: float64(36453), int64(1), object(1)
# memory usage: 32.5+ MB


#>>>> saving the df
destination_base_folder = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_unified_datasets/"
fullname_file_of_df_joined_new_design2 = destination_base_folder + "JoinNewDesign2CommonFtsof3oftop4FSsL1_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
