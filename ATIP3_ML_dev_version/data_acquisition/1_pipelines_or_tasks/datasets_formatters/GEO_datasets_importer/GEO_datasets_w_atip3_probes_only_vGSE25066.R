...
myGSE = "GSE25066" # used also to set the dataset's name
myGPL = "GPL96"
...
write.csv(peak_at_names_in_phdata, "GSE25066_phdata_entries_repaired.csv", row.names=T) # ... save the file)
# do the repairs by hand
# reload the file after the repairs
path2filerepaired1 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/GSE25066_phdata_entries_repaired.csv"
...
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er_status_ihc_esr1_for indeterminate: P","er_status_ihc: P")))]<-"positive"
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er_status_ihc_esr1_for indeterminate: N","er_status_ihc: N")))]<-"negative"
...
# peak_at_names_in_phdata_restricted_b4_tax_restriction <- peak_at_names_in_phdata_restricted  # already all samples are treated with taxanes # 508 samples
...
peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted[which(peak_at_names_in_phdata_restricted$TNBC %in% c("yes")),] ##! to save  # 178 samples
