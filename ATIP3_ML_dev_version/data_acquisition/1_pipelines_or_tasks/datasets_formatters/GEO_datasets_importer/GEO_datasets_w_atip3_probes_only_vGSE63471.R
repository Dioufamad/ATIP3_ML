...
myphcolsDesired <- c("geo_accession","characteristics_ch1.6","characteristics_ch1.7","characteristics_ch1.9")
peak_at_names_in_phdata_restricted <- peak_at_names_in_phdata[, myphcolsDesired]
# rename the cols for more controlable colnames
names(peak_at_names_in_phdata_restricted) <- c("geo_accession","ER_status","PR_status","pCR_status") # these two lines will rename the columns
...
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("ro: 1")))]<-"positive"
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("ro: 0")))]<-"negative"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("rp: 1")))]<-"positive"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("rp: 0")))]<-"negative"
...
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("rch: 1")))]<-"Yes"
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("rch: 0")))]<-"No"
...
peak_at_names_in_phdata_restricted$TNBC[which((peak_at_names_in_phdata_restricted$ER_status %in% c("positive"))
                                              |(peak_at_names_in_phdata_restricted$PR_status %in% c("positive")))]<-"no"
peak_at_names_in_phdata_restricted$TNBC[which((peak_at_names_in_phdata_restricted$ER_status %in% c("negative"))
                                              &(peak_at_names_in_phdata_restricted$PR_status %in% c("negative")))]<-"yes"
peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted[which(peak_at_names_in_phdata_restricted$TNBC %in% c("yes")),] ##! to save  # 52 samples
