...
myGSE = "GSE41998" # used also to set the dataset's name
myGPL = "GPL571"
...
myphcolsDesired <- c("geo_accession","characteristics_ch1.3","characteristics_ch1.6","characteristics_ch1.7","characteristics_ch1.8","characteristics_ch1.11")
...
unique(peak_at_names_in_phdata_restricted$treatment) 
...
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("pr: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("pr: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$HER2_status[which((peak_at_names_in_phdata_restricted$HER2_status %in% c("her2stat: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$HER2_status[which((peak_at_names_in_phdata_restricted$HER2_status %in% c("her2stat: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("pcr: Yes")))]<-"Yes"
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("pcr: No")))]<-"No"
...
# peak_at_names_in_phdata_restricted before restriction on patients treated with taxanes (TP) has  279 samples
# restrict to taxanes treated patients 
peak_at_names_in_phdata_restricted_TP <- peak_at_names_in_phdata_restricted[which((peak_at_names_in_phdata_restricted$treatment %in% c("treatment arm: Paclitaxel"))),] # 127 samples
# restrict to TP that are TNBC
peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted_TP[which(peak_at_names_in_phdata_restricted_TP$TNBC %in% c("yes")),] ##! to save  # 64 samples
