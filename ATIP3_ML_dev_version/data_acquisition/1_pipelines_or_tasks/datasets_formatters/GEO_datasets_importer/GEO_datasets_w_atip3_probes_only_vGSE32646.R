...
myGSE = "GSE32646" # used also to set the dataset's name
myGPL = "GPL570"
...
myphcolsDesired <- c("geo_accession","characteristics_ch1.6","characteristics_ch1.7","characteristics_ch1.8","characteristics_ch1.9")
...
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er status ihc: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$ER_status[which((peak_at_names_in_phdata_restricted$ER_status %in% c("er status ihc: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("pr status ihc: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$PR_status[which((peak_at_names_in_phdata_restricted$PR_status %in% c("pr status ihc: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$HER2_status[which((peak_at_names_in_phdata_restricted$HER2_status %in% c("her2 status fish: positive")))]<-"positive"
peak_at_names_in_phdata_restricted$HER2_status[which((peak_at_names_in_phdata_restricted$HER2_status %in% c("her2 status fish: negative")))]<-"negative"
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("pathologic response pcr ncr: pCR")))]<-"Yes"
peak_at_names_in_phdata_restricted$pCR_status[which((peak_at_names_in_phdata_restricted$pCR_status %in% c("pathologic response pcr ncr: nCR")))]<-"No"
# restrict to taxanes treated patients 
# peak_at_names_in_phdata_restricted_b4_tax_restriction <- peak_at_names_in_phdata_restricted  # already all samples are treated with taxanes # 115 samples
# peak_at_names_in_phdata_restricted <- peak_at_names_in_phdata_restricted[which((peak_at_names_in_phdata_restricted$treatment %in% c("treatment arm: Paclitaxel"))),] # 115 samples
...
peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted[which(peak_at_names_in_phdata_restricted$TNBC %in% c("yes")),] ##! to save  # 26 samples
...
num_of_uniques_genes_tracked <- length(list_of_uniques_genes_tracked_no_nanNunknown) # 23520 uniques genes tracked
...
peak_at_names_in_ftdata_restricted2MTUS1 <- peak_at_names_in_ftdata_restricted[which(peak_at_names_in_ftdata_restricted$"Gene Symbol" %in% c("MTUS1")),] # 4 probes (rows)
