...
myGSE = "GSE26639" # used also to set the dataset's name
myGPL = "GPL570"
...
myphcolsDesired <- c("geo_accession","her2 status:ch1","oestrogen receptor:ch1","progesterone receptor:ch1")
peak_at_names_in_phdata_restricted <- peak_at_names_in_phdata[, myphcolsDesired]
# peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted[which((peak_at_names_in_phdata_restricted$"her2 status:ch1" %in% c("negative"))
#                                                                                     &(peak_at_names_in_phdata_restricted$"oestrogen receptor:ch1" %in% c("negative"))
#                                                                                     &(peak_at_names_in_phdata_restricted$"progesterone receptor:ch1" %in% c("negative"))),]
peak_at_names_in_phdata_restricted$TNBC <- "NOT_CHANGED_YET"
peak_at_names_in_phdata_restricted$TNBC[which((peak_at_names_in_phdata_restricted$"her2 status:ch1" %in% c("positive"))
                                              |(peak_at_names_in_phdata_restricted$"oestrogen receptor:ch1" %in% c("positive"))
                                              |(peak_at_names_in_phdata_restricted$"progesterone receptor:ch1" %in% c("positive")))]<-"no"
peak_at_names_in_phdata_restricted$TNBC[which((peak_at_names_in_phdata_restricted$"her2 status:ch1" %in% c("negative"))
                                              &(peak_at_names_in_phdata_restricted$"oestrogen receptor:ch1" %in% c("negative"))
                                              &(peak_at_names_in_phdata_restricted$"progesterone receptor:ch1" %in% c("negative")))]<-"yes"
peak_at_names_in_phdata_restricted2TNBC <- peak_at_names_in_phdata_restricted[which(peak_at_names_in_phdata_restricted$TNBC %in% c("yes")),] ##! to save
...
num_of_uniques_genes_tracked <- length(list_of_uniques_genes_tracked_no_nanNunknown) 
...
peak_at_names_in_ftdata_restricted2MTUS1 <- peak_at_names_in_ftdata_restricted[which(peak_at_names_in_ftdata_restricted$"Gene Symbol" %in% c("MTUS1")),]
...
paste("- # of TNBC samples in initial # samples : ",num_tnbc_in_cohort, sep='') 
