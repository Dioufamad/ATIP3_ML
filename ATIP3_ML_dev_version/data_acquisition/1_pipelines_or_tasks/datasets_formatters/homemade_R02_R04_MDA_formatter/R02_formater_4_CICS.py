#>>>>>>>>>>>>>>>>>>>>>>>>>>> REMAGUS02 DATASET FORMATTING FOR ATIP3_ML SCRIPT <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
from engines.data_engine1_mgmt import data_mgmt_6
...
# 	logbasedir = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/outputs"
...
# ----for the choice to rename the features (probes) or not
rename_fts = "no"
# rename_fts = "yes"
...
if cohort_used == "REMAGUS02":
	file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/tsv/REMAGUS02_Donnees_genomiques_226x54676_totales.tsv" # @ home
	sep_in_file = "\t"
	supporting_file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/support/REMAGUS02-Données cliniques.xls" # @ home
	sheet_id = "extractionCNahmias"
	file4annot_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/annotations_ready4use/REMAGUS02_PSI_GS_54675.csv"
	sep_in_file4annot = ","
elif cohort_used == "REMAGUS04":
	file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/tsv/REMAGUS04normData_R04_142_CNahmias.tsv" # @ home
	sep_in_file = "\t"
	supporting_file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/support/REMAGUS04-Données cliniques.xlsx" # @ home
	sheet_id = "ExtracCNahmias2"
	file4annot_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/annotations_ready4use/REMAGUS04_PSI_GS_22215.csv"
	sep_in_file4annot = ","
elif cohort_used == "MDAnderson":
	file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/tsv/MDAnderson_MDA133_Expression.tsv" # @ home
	sep_in_file = "\t"
	supporting_file_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/support/MDAnderson-MDA133CompleteInfo20060418.xls" # @ home
	sheet_id = "MDA133CompleteInfo20060418"
	file4annot_path = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version/atip3_material/3c_data_trial1/annotations_ready4use/MDAnderson_PSI_GS_22215.csv" # uses the same as REMAGUS04 or made from copy of it
	sep_in_file4annot = ","
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>> README <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
print("Welcome in the formatting tool for the Remagus02, Remagus04, and MDAanderson datasets in direction of ATIP3_ML")
...
if cohort_used == "REMAGUS02" :
	...
	print("-------step 17 : A-putting the samples column at last position (no impact on the ATIP3_ML preprocessing) and tagging the 3 groups of columns to manipulate them easier......") # if decided by user,
	...
	if rename_fts == "yes":
		...
		print("the features name have not been changed.")
	...
	if tag_decision_launching_way in ["cmd_line","cl"]: # launch the script in a terminal
		...
		root_until_output_folder = rest_of_abs_path_b4_content_root + "ATIP3_ML/ATIP3_ML_dev_version" # whetever the command center
	...
	print("File saved !")
	print(cohort_used,"dataset formatting for ATIP3_ML analysis is done!")
