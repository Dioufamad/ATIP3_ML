...
# Objective : do the FS idea1 thinking 2 for the platform "Affymetrix HG U133 Plus 2"
'''
...
list_of_3_cohorts_with_most_samples = ["GSE26639","GSE32646"]
# lets restricted to only those cohorts (we are waiting for a total of 40+18 = 58 samples
df_restricted1 = df[df['cohort'].isin(list_of_3_cohorts_with_most_samples)] # has 58 samples
...
list_of_tags_for_cohorts_2keep_their_features = ["_in_GSE26639","_in_GSE32646"]
...
# >>>>>> check the datatypes
df_restricted2.info()
# Index: 58 entries, GSM655625 to GSM809294
# Columns: 24070 entries, A1CF_in_GSE26639 to cohort
# dtypes: float64(24068), int64(1), object(1)
# memory usage: 10.7+ MB

#>>>> saving the df
fullname_file_of_df = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/JoinNewDesign1CommonFtsof6_FSidea1thinking2ptfU133plus2_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
