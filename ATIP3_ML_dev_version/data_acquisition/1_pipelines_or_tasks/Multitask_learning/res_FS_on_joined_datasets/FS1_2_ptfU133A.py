...
# Objective : do the FS idea1 thinking 2 for the platform "Affymetrix HG U133A"
'''
...
list_of_3_cohorts_with_most_samples = ["GSE25055","GSE20194"]
# lets restricted to only those cohorts (we are waiting for a total of 32+54 = 86 samples
df_restricted1 = df[df['cohort'].isin(list_of_3_cohorts_with_most_samples)] # has 86 samples
...
list_of_tags_for_cohorts_2keep_their_features = ["_in_GSE25055","_in_GSE20194"]
...
# >>>>>> check the datatypes
df_restricted2.info()
# Index: 86 entries, GSM615107 to GSM505602
# Columns: 24070 entries, A1CF_in_GSE25055 to cohort
# dtypes: float64(24068), int64(1), object(1)
# memory usage: 15.8+ MB

#>>>> saving the df
fullname_file_of_df = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/JoinNewDesign1CommonFtsof6_FSidea1thinking2ptfU133A_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
