# SPAMS custom estimator on the 6 cohorts joined dataset (common fts)
# NB : A DATASET TO USE FOR a TEST IS SUPPLIED WITH THIS SCRIPT.
# THE DATASET FILENAME IS : "JoinNewDesign1CommonFtsof6_FSidea1thinking1or3_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
# PLEASE REPLACE THE ABSOLUTE PATH AT THE LINE "local_link_to_csv_dataset= ....." WITH THE ABSOLUTE PATH OF THE DATASET YOU DOWNLOADED
...
# >>>>>>>>>>>>>>>>>>>>>>>>>>>> lets build the gallery of our hyperparamerters values here
regularization_used = "SpamsSparseGroupL1LogReg"
# param grid to use for tests
