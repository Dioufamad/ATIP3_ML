# This is a script to run the first linear regression tests on the 7 selected microarray cohorts

#>>>>>>>>>>>>>>>> logistic regression (rectify the following code into a logistic regression
