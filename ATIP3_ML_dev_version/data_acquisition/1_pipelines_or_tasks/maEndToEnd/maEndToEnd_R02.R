...
# step new : clean the environment 
rm(list=ls())
require(GEOquery)

# step new : install Geoquery library 
BiocManager::install("GEOquery")
# step new : use this to check if the use GEO accession number is correct
#http://www.ncbi.nlm.nih.gov/geo/browse/
# or GEO2R

# 3 : Downloading the raw data from ArrayExpress
raw_data_dir_R02 <- tempdir()

if (!dir.exists(raw_data_dir_R02)) {
  dir.create(raw_data_dir_R02)
}

anno_AE <- getAE("E-MTAB-2967", path = raw_data_dir_R02, type = "raw") 
