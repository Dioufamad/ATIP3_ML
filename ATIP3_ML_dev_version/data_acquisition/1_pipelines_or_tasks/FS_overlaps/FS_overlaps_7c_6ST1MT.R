...
list_paths2files <- c(path2file1,path2file2,path2file3,path2file4,path2file5,path2file6,path2file7)
# >>>>>>>>>>> a list of tag_alg
...
list_titles_initial_sets_in_order_best2worstperf = c("FS_ST_L1_On_Remagus04","FS_ST_L1_On_MDAnderson_part1of2_310","FS_MT_SGL1_On_6_joined_dts","FS_ST_L1_On_BMS_Horak_2013","FS_ST_L1_On_Osaka_Miyake_2012","FS_ST_L1_On_Remagus02","FS_ST_L1_On_Fudan_MAQC2BR")
...
avgF1Score <- c(0.813,0.65,0.605,0.583,0.567,0.383,0.373)
...
Platforms_ID <-c("Affymetrix_HG_U133A_2_0","Affymetrix_HG_U133A","All_Platforms_Common_Genes","Affymetrix_HG_U133A_2_0",
                 "Affymetrix_HG_U133_Plus_2_0","Affymetrix_HG_U133_Plus_2_0","Affymetrix_HG_U133A")
...
PlatformsInitialPoolofGenes <-c("AffyHGU133A2 : 12151","AffyHGU133A : 12151","Common_Genes_Across_All3Platforms : 72204","AffyHGU133A2 : 12151",
                                "AffyHGU133Plus2 : 19417","AffyHGU133Plus2 : 19419","AffyHGU133A : 12151")
# --- joining the cols
...
upset(upsetplot_building_matrix, 
      ...
      queries = list(list(query = intersects, params = list("FS_ST_L1_On_Remagus04"), color = "green", active = T, query.name = "Specific to the best performing FS"),
                     list(query = intersects, params = list("FS_ST_L1_On_Remagus04", "FS_ST_L1_On_MDAnderson_part1of2_310", "FS_MT_SGL1_On_6_joined_dts"), color = "blue", active = T, query.name = "Intersection of top 3 performing FS"),
                     list(query = intersects, params = list("FS_ST_L1_On_Remagus04","FS_ST_L1_On_MDAnderson_part1of2_310","FS_MT_SGL1_On_6_joined_dts","FS_ST_L1_On_BMS_Horak_2013","FS_ST_L1_On_Osaka_Miyake_2012","FS_ST_L1_On_Remagus02","FS_ST_L1_On_Fudan_MAQC2BR"), color = "red", active = T, query.name = "Intersection of all FS"),
...
# chunk used to save the upsetplot_building_matrix for a table with presence and absence of all fts across the FS of the L1 lasso
# - the file name definition (using list_tag_alg and upsetplot_building_matrix)

list_algs_analysed = unique(as.character(list_tag_alg))
str_for_algs_analysed = paste(list_algs_analysed, collapse = '_and_')
num_fs_analysed = length(list_tag_alg)
num_rows = dim(upsetplot_building_matrix)[1]
num_cols = dim(upsetplot_building_matrix)[2]
...
filename_of_table_to_save = paste(prefix_path_until_folder_of_location,"presence_absence_table_for_",str_for_algs_analysed,"_",num_fs_analysed,"FSs_",num_rows,"rows_",num_cols,"cols_GEX.csv", sep='')
# - if okay , save now in .csv
table_to_save = upsetplot_building_matrix
