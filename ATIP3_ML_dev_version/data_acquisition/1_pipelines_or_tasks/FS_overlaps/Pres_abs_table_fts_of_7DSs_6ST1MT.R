...
# Version : for the 7 initial datasets 
...
# >>> FS 1
path2file1 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE41998_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg1 = "DS_ST_L1" # needed to see if it is a dataset towards ST or MT (if MT, the fts name ahas to be analysed to get real name)
tag_numcohort1 = "GSE41998"
tag_nickname_cohort1 = "BMS_Horak_2013"
# >>> FS 2
path2file2 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE26639_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg2 = "DS_ST_L1"
tag_numcohort2 = "GSE26639"
tag_nickname_cohort2 = "Remagus02"
# >>> FS 3
path2file3 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE32646_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg3 = "DS_ST_L1"
tag_numcohort3 = "GSE32646"
tag_nickname_cohort3 = "Osaka_Miyake_2012"
# >>> FS 4
path2file4 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE25055_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg4 = "DS_ST_L1"
tag_numcohort4 = "GSE25055"
tag_nickname_cohort4 = "MDAnderson_part1of2_310"
# >>> FS 5
path2file5 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE20194_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg5 = "DS_ST_L1"
tag_numcohort5 = "GSE20194"
tag_nickname_cohort5 = "Fudan_MAQC2BR"
# >>> FS 6
path2file6 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_ml_dataset_type1/GSE63471_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_cohortname.csv"
tag_alg6 = "DS_ST_L1"
tag_numcohort6 = "GSE63471"
tag_nickname_cohort6 = "Remagus04"
# >>> FS 7 aka MT
path2file7 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_warehouse/outputs/atip3_unified_datasets/JoinNewDesign2CommonFtsof6_ml_dataset_taxanesonly_ATIP3lowonly_GEX_pCR_6cohortname.csv"
tag_alg7 = "DS_MT_SGL1"
...
looping_index <- 0
for (a_path2afile in list_paths2files) { # for test : a_path2afile = list_paths2files[2]
  ...
  fs_table <- read.csv(file = a_path2afile, header = TRUE, check.names = FALSE) 
  # (an error changing fts names content separator into dots is solved by putting check.names = FALSE)
  # (source : https://stackoverflow.com/questions/43999260/names-of-columns-change-from-csv-to-r-dot-instead-of-slash)
  # (we never this error before because until now this model of script used to import files where fts names are in rows not cols)
  # - NB : we need a table with 2 cols only (Features and another one)
  # + drop 1 st col (X), drop 2 last cols (Y_pcr and cohort)
  fs_table[,1] <- NULL
  fs_table[,ncol(fs_table)] <- NULL
  fs_table[,ncol(fs_table)] <- NULL
  # + the fts are the cols name : we need to transpose the table to have them as rownames (in order to create a col with it later)
  fs_table = t(fs_table)
  # + make the rownames content as the 1st col with Features as title of col
  fs_table <- data.frame(Features = row.names(fs_table), fs_table) 
  # + remove the old fts names that were the index
  rownames(fs_table) <- NULL 
  # + restrict the cols now to only 2 cols (Features and another one) (we keep another one to just not manipulate 1 col table so that the table wont be empty at some steps)
  fs_table <- fs_table[,c(1,2)]
...
upsetplot_building_matrix_cols_by_perf_order = upsetplot_building_matrix[c("Unique_features_across_all_initial_sets","DS_ST_L1_On_Remagus04","DS_ST_L1_On_MDAnderson_part1of2_310","DS_MT_SGL1_On_6_joined_dts",
                                                                           "DS_ST_L1_On_BMS_Horak_2013","DS_ST_L1_On_Osaka_Miyake_2012","DS_ST_L1_On_Remagus02","DS_ST_L1_On_Fudan_MAQC2BR")]
...
names(upsetplot_building_matrix_cols_by_perf_order) <- c("Features_bis","DS_Remagus04","DS_MDAnderson_part1of2_310","DS_MT_6_dts",
                                                         "DS_BMS_Horak_2013","DS_Osaka_Miyake_2012","DS_Remagus02","DS_Fudan_MAQC2BR")
...
# table_pres_abs = table_pres_abs[c("Features_bis","DS_Remagus04","DS_MDAnderson_part1of2_310","DS_MT_6_dts",
#                                   "DS_BMS_Horak_2013","DS_Osaka_Miyake_2012","DS_Remagus02","DS_Fudan_MAQC2BR")]
# #<<<<<<<<<<<<
