...
# Version : for the 4 FS of LASSO (L1) (3 FSs in top 4 FSs and new MTofthose3)
...
# >>> FS 1new
path2file1 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/scikit_learn/Output_Regr_SklearnL1LogReg_Allfts_Singletask_BRCA_NACTaxanesBR_GEX_MA_Trial0066_NonNullCoefs.csv"
tag_alg1 = "FS_ST_L1"
tag_numcohort1 = "GSE63471"
tag_nickname_cohort1 = "Remagus04"

# >>> FS 2new
path2file2 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/scikit_learn/Output_Regr_SklearnL1LogReg_Allfts_Singletask_BRCA_NACTaxanesBR_GEX_MA_Trial0064_NonNullCoefs.csv"
tag_alg2 = "FS_ST_L1"
tag_numcohort2 = "GSE25055"
tag_nickname_cohort2 = "MDAnderson_part1of2_310"

# >>> FS 3new
path2file3 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/scikit_learn/Output_Regr_SklearnL1LogReg_Allfts_Singletask_BRCA_NACTaxanesBR_GEX_MA_Trial0061_NonNullCoefs.csv"
tag_alg3 = "FS_ST_L1" # needed to see if it is a dataset towards ST or MT (if MT, the fts name ahas to be analysed to get real name)
tag_numcohort3 = "GSE41998"
tag_nickname_cohort3 = "BMS_Horak_2013"


# >>> FS 3new aka MTof3
path2file4 = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/spams_sparse_group_lasso_l2_l1onlyused_3oftop4FSsL1/Output_Regr_SPAMSSparseGroupL1L2LogReg_CommonFtsMT3ofTop4FSsL1_BRCA_NACTaxanesBR_GEX_MA_Trial1MT3ofTop4FSsL1_NonNullCoefs.csv"
tag_alg4 = "FS_MT_SGL1"
tag_numcohort4 = "6GSEs"
tag_nickname_cohort4 = "6_joined_dts"
# >>>>>>>>>>> a list of paths to loop on and get the info needed
list_paths2files <- c(path2file1,path2file2,path2file3,path2file4) # needed
# >>>>>>>>>>> a list of tag_alg
list_tag_alg <- c(tag_alg1,tag_alg2,tag_alg3,tag_alg4)
# >>>>>>>>>>> a list of tag_numcohort
list_tag_numcohort <- c(tag_numcohort1,tag_numcohort2,tag_numcohort3,tag_numcohort4)
# >>>>>>>>>>> a list of tag_nickname_cohort
list_tag_nickname_cohort <- c(tag_nickname_cohort1,tag_nickname_cohort2,tag_nickname_cohort3,tag_nickname_cohort4)
...
upsetplot_building_matrix_cols_by_perf_order = upsetplot_building_matrix[c("Unique_features_across_all_initial_sets","FS_ST_L1_On_Remagus04","FS_ST_L1_On_MDAnderson_part1of2_310","FS_ST_L1_On_BMS_Horak_2013",
                                                                           "FS_MT_SGL1_On_6_joined_dts")]
...
names(upsetplot_building_matrix_cols_by_perf_order) <- c("Features_bis","FS_Remagus04","FS_MDAnderson_part1of2_310","FS_BMS_Horak_2013","FS_MT_3_dts")
...
prefix_path_until_folder_of_location = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/presence_absence_tables/"
