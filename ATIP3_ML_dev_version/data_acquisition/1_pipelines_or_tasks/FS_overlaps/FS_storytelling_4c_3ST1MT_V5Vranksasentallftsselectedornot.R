...
final_table_V6_sorted_summary = final_table_V6_sorted[c("Features", "s_all", 
                                                        ...
                                                        "Percentage_selection_among_top4FSs", "FS_Remagus04","FS_MDAnderson_part1of2_310", "FS_BMS_Horak_2013","FS_MT_3_dts")] # changed to not include an added final rank # to save
...
# final_table_V6_sorted_summary_selectedin3catleast$FINAL_RANK_IN_THIS_LIST[order(final_table_V6_sorted_summary_selectedin3catleast$MEAN_OF_RANKS_ACROSS_THE_TOP_4_FSs)] <- 1:nrow(final_table_V6_sorted_summary_selectedin3catleast) # not needed because the rank are ent already
...
write.xlsx(list_of_tables_from_ranks_of_coefs, file = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/1_pipelines_or_tasks/Multitask_learning/res_learning_tasks/outputs/runs/Tables_of_pertinent_genes_following_coefs_ranks_with_Top4FSsVranksasentallftsselectedornot.xlsx")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~END OF FILE
