...
# version with only best in single task and best in multitask
# imports 
...
list_paths2files <- c(path2file6,path2file7)
# >>>>>>>>>>> a list of tag_alg
list_tag_alg <- c(tag_alg6,tag_alg7)
# >>>>>>>>>>> a list of tag_numcohort
list_tag_numcohort <- c(tag_numcohort6,tag_numcohort7)
# >>>>>>>>>>> a list of tag_nickname_cohort
list_tag_nickname_cohort <- c(tag_nickname_cohort6,tag_nickname_cohort7)
...
list_titles_initial_sets_in_order_best2worstperf = c("FS_ST_L1_On_Remagus04","FS_MT_SGL1_On_6_joined_dts")
...
Platforms_ID <-c("Affymetrix_HG_U133A_2_0","All_Platforms_Common_Genes")
...
PlatformsInitialPoolofGenes <-c("AffyHGU133A2 : 12151","Common_Genes_Across_All3Platforms : 72204")
# --- joining the cols
