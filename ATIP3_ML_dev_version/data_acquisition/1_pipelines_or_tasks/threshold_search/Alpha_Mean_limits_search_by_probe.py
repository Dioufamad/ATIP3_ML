...
# ----for the probe to use to compute Mg
mtus1_probe_2_focus_on = "GSasMTUS1wGBANasAI695017wPSIas212093_s_at"
# mtus1_probe_2_focus_on = "GSasMTUS1wGBANasBE552421wPSIas212095_s_at"
# mtus1_probe_2_focus_on = "GSasMTUS1wGBANasAL096842wPSIas212096_s_at"
# mtus1_probe_2_focus_on = "GSasMTUS1wGBANasAI028661wPSIas239576_at"
...
# restrict to samples of low end cluster (by selecting the low end cluster ie value 1 in col Clusters
df_Mg_start_low_end_only = df_Mg_start[df_Mg_start['Clusters'] == 1]
...
# sort as descending on the col of probe to focus on
# mtus1_probe_2_focus_on is chosen at start of script
df_Mg_start_low_end_cols_restricted= df_Mg_start_low_end_cols_restricted.sort_values(mtus1_probe_2_focus_on, axis=0, ascending=False, kind='mergesort')
...
Mg = df_Mg_start_low_end_cols_restricted_sortedOnMeanRow.at[0,mtus1_probe_2_focus_on]
# - keep the sample name of the sample at the limit for later computation for Std
...
# a way to report the results faster is to print them and copy paste them
# - print a summary of the analysis factors :
print("Computation of alpha made with :")
print("- cohort :",cohort_used)
print("- MTUS1 probe :",mtus1_probe_2_focus_on)
print("- origin of the top 20 HKGs :",origin_of_top20_HKGs)
# sucessively Mg, Std, and alpha
print("Following are the Mg, Std, and alpha found :")
for i in dict_overall_results["Results"]:
	print(i)
...
# # save the report df
# if cohort_used == "REMAGUS02":
# 	name_overall_results = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/R02_overall_results.csv"
# elif cohort_used == "REMAGUS04":
# 	name_overall_results = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/R04_overall_results.csv"
# else : # cohort_used == "MDAnderson":
# 	name_overall_results = "/home/amad/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/data_acquisition/output/MDA_overall_results.csv"
#
