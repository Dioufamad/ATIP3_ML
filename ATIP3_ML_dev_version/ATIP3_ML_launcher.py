...
import warnings
from engines.data_engine1_mgmt import data_mgmt_1,data_mgmt_2,data_mgmt_6,unifier_creator,data_loadout_right_corresponder,data_mgmt_5,feature_values_type_caracterisation,reduction_of_dataset_for_testing_purpose
from engines.data_engine2_allocation import add_entry_in_dict,il1_multiprocessing_handler,il1_sequential_processing_handler,stratKfolds_making
from engines.learning_algs_engine import classifier_introduction,classifier_model_training,classifier_model_prediction,classifier_as_Keras_DNN_intro_train_pred,classifier_as_SVM_intro_train_pred # all for RF ML alg choice using tag_name, training and prediction
from engines.learning_algs_engine import classif_algs_roundup
from engines.learning_algs_engine import prediction_calling,raw_predictions_pusher,called_predictions_pusher # for predictions treatments
from engines.metrics_engine import calculate_mcc_w_storing,pd_ml_classif_report_on_cm_binary
from engines.watcher_engine import timer_started,duration_from,bcolors,roc_curve_updater_after_one_iteration_of_the_mdl,roc_curve_finisher_after_all_iterations_of_the_mdl,average_roc_curve_init,average_roc_curve_finisher,df_of_results_for_metrics_one_mdl_creator,df_of_results_for_metrics_all_mdls_creator,df_of_results_for_FS_one_mdl_creator
from engines.fs_engine import ranker_by_pval_v2,OMC_founder_in_dict_MCs_MCCs
...
# from engines.data_engine1_mgmt import data_mgmt_3
# import random
# from engines.data_engine2_allocation import testset_indexes_spacer,testset_indexes_selector, trainingset_indexes_selector, set_creator_w_rows_index
# from engines.Classif_algs_engine import classifier_introduction,classifier_model_training,classifier_model_prediction,classifier_introduction2,classifier_model_training2,classifier_model_prediction2,classifier_introduction2_dflt0 #1 XGBoost_C_1 #2 RF_dflt1 # RF intro dflt0
from engines.learning_algs_engine import regr_algs_roundup
# from engines.fs_engine import length_features_list,maximal_complexity_as_half_tr,list_of_complexities_ext,list_of_complexities_ltd,stratification1,feat_selection1
# from engines.metrics_engine import r2,rmse,spearmanr_test,spearmanr_test_dec,r2_dec,rmse_dec,restriction_of_MCCs_wide,df_multiplier_in_rows
# from engines.fs_engine import eliminate_non_variable_fts
...
our_args_parser = argparse.ArgumentParser(prog='ATIP3_ML',description="Welcome in ATIP3_ML.", epilog="Thank you for using ATIP3_ML. Questions and contributions are waited at amaddioufb13@gmail.com.")
...
# Input data files are available in the "./ATIP3_ML/.../datasets_to_process_folder/" & "./ATIP3_ML/.../table_of_treatments_details/" directories as csv files.
...
if command_center == "Gustave_Roussy" : # @ GR
	...
	if cohort_used == "REMAGUS02" : # for remagus_02
		data_profiles_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/datasets_to_process_folder/R02"
		data_drugs_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/table_of_treatments_details"
	if cohort_used == "REMAGUS04" : # for remagus_04
		data_profiles_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/datasets_to_process_folder/R04"
		data_drugs_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/table_of_treatments_details"
	if cohort_used == "MDAnderson" : # for remagus_04
		data_profiles_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/datasets_to_process_folder/MDA"
		data_drugs_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/table_of_treatments_details"
	else : # cohort_used = "PDX_BRCA_T17_GEX"
		data_profiles_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/slate_data/datasets_to_process_folder/real_val_prof_test"
		data_drugs_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/table_of_treatments_details"
