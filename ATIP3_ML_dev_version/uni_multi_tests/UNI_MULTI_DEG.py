...
if command_center == "Gustave_Roussy" :
	...
	file_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/datasets_to_process_folder/R02/BRCA_Treatment11_REMAGUS02xNACx221x54675_GEX.csv" # @ home
	sep_in_file = ","
	supporting_file_path = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version/atip3_material/table_of_treatments_details/treatments_details_source.csv" # @ home
	# sep_in_file_sup = "," # use the one for dataset
...
# -------step 20 : Save a copy of the final dframe  ##! last_stop this was okay and working, make it plush and hot launchable in ATIP3_ML
...
if tag_decision_launching_way in ["cmd_line","cl"]: # launch the script in a terminal
	...
	if command_center == "Gustave_Roussy":
		root_until_output_folder = "/home/amad/PycharmProjects/ATIP3_in_GR/ATIP3_ML/ATIP3_ML_dev_version"
	else: # command_center == "Home"
		root_until_output_folder = "/home/khamasiga/PALADIN_1/3CEREBRO/garage/projects/ATIP3/ATIP3_ML/ATIP3_ML_dev_version"
